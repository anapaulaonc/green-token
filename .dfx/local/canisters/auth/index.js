...
import { idlFactory } from './auth.did.js';
export { idlFactory } from './auth.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUTH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auth.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auth canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auth.did.js")._SERVICE>}
 */
export const auth = createActor(canisterId);
